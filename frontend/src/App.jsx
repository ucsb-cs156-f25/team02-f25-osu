...
function App() {
  ...
  return (
    <Routes>
      ...
      {hasRole(currentUser, "ROLE_USER") && (
        <>
          <Route exact path="/ucsb-dining-commons-menu-items" element={<UCSBDiningCommonsMenuItemIndexPage />} />
        </>
      )}
      {hasRole(currentUser, "ROLE_ADMIN") && (
        <>
          <Route
            exact
            path="/ucsb-dining-commons-menu-items/edit/:id"
            element={<UCSBDiningCommonsMenuItemEditPage />}
          />
          <Route
            exact
            path="/ucsb-dining-commons-menu-items/create"
